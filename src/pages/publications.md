...
A collection of my academic papers, conference talks, and research presentations.
...
@inproceedings{oztas2026localizing,
  title={Localizing Hot Pixels in Android Malware Images},
  author={Oztas, Can and Sen, Sevil},
  booktitle={EAI SecureComm 2026},
  year={2026},
...
@mastersthesis{oztas2025cnn,
  title={Convolutional Neural Network Based Android Malware Detection and Localization},
  author={Oztas, Refik Can},
  school={Hacettepe University},
  year={2025},
  address={Ankara, Turkey},
  url={https://research.hacettepe.edu.tr/tr/studentTheses/convolutional-neural-network-based-android-malware-detection-andl-3/}
}

@misc{oztas2024hacktrick,
  title={How to Hack Your AI ? - Yapay Zekan{\i} Nas{\i}l Hacklersin?},
  author={Oztas, C.},
  howpublished={Hacktrick 2024},
  year={2024},
  address={Ankara, Turkey},
  url={https://www.linkedin.com/feed/update/urn:li:activity:7197585079924101120/}
}

@inproceedings{oztas2023comparative,
  title={Comparative Analysis of Differential Privacy over Multiple Data Sets},
  author={Oztas, Refik Can and Tugrul, Bulent},
  booktitle={8th International Scientific Conference "Telecommunications, Informatics, Energy and Management" (TIEM)},
  year={2023},
  month={December},
  address={Band{\i}rma, Turkey},
